...
* **chat-ia:** modo Orquestrador como padrão, delegando entre Modelagem e Codificar ([7a79d4b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/7a79d4b064f601fc56188276b8e06277263ceeb3))
...
* **bench:** paredes cinza no streaming — dedup sem mesclar materiais ([014b55f](https://github.com/BuuhV-Projects/cortex-game-engine/commit/014b55f2efa2e60a8e3568701dc1454e8d06d47a))
* **chat:** exibir cache read/write nas stats do turno ([15dc305](https://github.com/BuuhV-Projects/cortex-game-engine/commit/15dc305f9a8c2d6c77a157e70e700d5e68fd1996))
* **ci:** gate de testes roda num clone limpo (TDR-0004) ([9adc6ed](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9adc6ed1bdaeadedb697fd6039422b75cfc7b5d3))
* **engine:** HUD de métricas sobrevive à troca de fase (game.reset) ([82a8021](https://github.com/BuuhV-Projects/cortex-game-engine/commit/82a8021485c55573b44f4cddcdbe4df15c4b627f))
* **engine:** raycast ignora SkinnedMesh + clamp de deltaTime no GameLoop (ADR-0118) ([7472fef](https://github.com/BuuhV-Projects/cortex-game-engine/commit/7472fefb39f594f5039194168c22240905fd6bdd))
* **engine:** teardown de fase sem vazamento de memória/GPU (SPEC-0152) ([f8a4631](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f8a463104e9125ec0053bc7fa41c60b08c698cd1))
* **export:** evita EPERM ao limpar dist-native (delete-pending do Windows) ([9665ada](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9665adacbb2b854ba8ff261e40bb5ee60a3b9a16))
* **export:** pasta 'builded-<id>' + 'abrir pasta' vai pro destino real ([ff276b3](https://github.com/BuuhV-Projects/cortex-game-engine/commit/ff276b329b39f133cb928882e280ff93ffeb0add))
* **export:** perf-log.txt só com métricas ativas (TDR-0004) ([7ebb0a3](https://github.com/BuuhV-Projects/cortex-game-engine/commit/7ebb0a347e7056218cab1a210047c62fda024d9e))
* **export:** texturas de cor em UASTC+RDO+Zstd — ETC1S bandava os gradientes (ADR-0119) ([ef90133](https://github.com/BuuhV-Projects/cortex-game-engine/commit/ef901334b2c1cb3d12868b596b61b1a27ab746cc))
* **ide:** registra scene/Streaming no VENDOR_TYPE_MODULES ([6632dab](https://github.com/BuuhV-Projects/cortex-game-engine/commit/6632dabfa18ad22b4f4db52f7128370190afd44f))
* **ide:** substituir window.confirm/alert por diálogos nativos via IPC ([bf583e7](https://github.com/BuuhV-Projects/cortex-game-engine/commit/bf583e7403b6fad5e10a91e0ed391818bb965cbc))
* **input+native:** gate de foco no gamepad (eco entre instâncias) + erros webgpu/JS no error_log.txt ([d252cec](https://github.com/BuuhV-Projects/cortex-game-engine/commit/d252cec45c320fa8c6816c1fec930a41a0e2a30e))
* **input:** controle nasce com o pulo 'já pressionado' (SPEC-0156, 2ª rodada) ([a3f0614](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a3f0614da5e8510e911c490f7443d57a7a2dbbfc))
* **input:** despausar não vaza a borda do botão de pulo (SPEC-0156) ([dac7c03](https://github.com/BuuhV-Projects/cortex-game-engine/commit/dac7c034d12a3cf9abb4716e6a575e9c596e8ff1))
* **native+bench:** splash sinaliza fim ao JS + barra de loading enche durante a carga ([a225a18](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a225a1831fe3abd69407440990b2f8fabd351629))
* **native:** bright pass e ganho do bloom iguais ao three (paridade de brilho) ([0ea0b5e](https://github.com/BuuhV-Projects/cortex-game-engine/commit/0ea0b5ec613a7fde9aecc7a983d9d67303bca98b))
* **native:** crash fatal em fullscreen — destroy() de buffer/textura vira release-only ([c229295](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c2292955b7464a48f7b4880873280962a68d76c3))
* **native:** liberação determinística de GPU/RAM no host (ADR-0153) ([1a8a0ee](https://github.com/BuuhV-Projects/cortex-game-engine/commit/1a8a0ee7969d51786b5b546df3772540fa7d4b88))
* **native:** transpilar block-scoping no bundle (Hermes quebra let em closure) ([8638a4a](https://github.com/BuuhV-Projects/cortex-game-engine/commit/8638a4a055db96792e486082c94d774362330d67))
* **native:** window.close() encerra o app no export (ADR-0120) ([52c3655](https://github.com/BuuhV-Projects/cortex-game-engine/commit/52c3655fe84d918ffe00a3291edc6db6f581c59d))
* **scene:** buildScene fecha com updateMatrixWorld — raycast correto no 1º tick ([78842b3](https://github.com/BuuhV-Projects/cortex-game-engine/commit/78842b34f7fbe0d60fc3b6abbf72513d6fc03af6))
* **scripts:** restaurar raycast e destruir instancias no Stop (ADR-0143) ([7938093](https://github.com/BuuhV-Projects/cortex-game-engine/commit/7938093a64c774cce89b99a22d57fb269e577fe2))
* **sombra:** far plane do CSM tem que cobrir lightMargin + shadowDistance ([9eb5b5a](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9eb5b5a2b5e43366a8dd345130a4822f4f8c82ca))
* visible ([7b712c2](https://github.com/BuuhV-Projects/cortex-game-engine/commit/7b712c2f680305b98158b33d81ab7e4637bd12ee))


### Features

* **bench:** bake offline da cidade + fixes de render nativo (SPEC-0140) ([14253f1](https://github.com/BuuhV-Projects/cortex-game-engine/commit/14253f195834fd0288ae1c6a0b53a4fd6459a667))
* **bench:** boot splash→menu→loading→jogo + LOD renderiza mais longe ([35a9106](https://github.com/BuuhV-Projects/cortex-game-engine/commit/35a91067527213046fbe4ba110f1078ae3489e47))
* **bench:** cidade sintética com modelos .glb reais (City Bench Test) ([949847e](https://github.com/BuuhV-Projects/cortex-game-engine/commit/949847e379e482fd83ff45c6b7b589519a8ac302))
* **bench:** streaming de BYTES por célula — boot <1s (SPEC-0140) ([b8e6956](https://github.com/BuuhV-Projects/cortex-game-engine/commit/b8e6956c937af0ce6ca1b2a95666c011715a3d53))
* **bloom:** brilho por objeto (material.intensity HDR) + ganho nomeado ([eac658f](https://github.com/BuuhV-Projects/cortex-game-engine/commit/eac658f784d627b18d77ebdc3519e4c2eb7212b0))
* **chat-ia:** câmera de inspeção livre no playtest (ADR-0131) ([9a8c3d7](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9a8c3d73809ffde56792cf0980ac8f04ca79fb6f))
* **chat-ia:** seletor de modelo (Sonnet/Opus/Haiku) no Studio ([5a3c24b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/5a3c24bb7e871100c4d5aac339198720f3e06ba7))
* **editor:** alternar eixos globais/locais do gizmo com X (SPEC-0144) ([9cd45e7](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9cd45e734cd5c42e77c49074d20338cbf47f035e))
* **editor:** desativar (acinzentar) campos por-objeto na multi-seleção ([0463fe9](https://github.com/BuuhV-Projects/cortex-game-engine/commit/0463fe91ba1f1304f8a5fbc9feb2e725774f9362))
* **editor:** eixos locais por padrao no gizmo e atalho X na legenda ([08ac533](https://github.com/BuuhV-Projects/cortex-game-engine/commit/08ac5339e9c561567284495f4070fb02d789de05))
* **editor:** multi-seleção com Ctrl+click e aplicação em lote no Inspector (ADR-0117) ([edecda4](https://github.com/BuuhV-Projects/cortex-game-engine/commit/edecda40fbae5f27a9318d2fa092b4c334f1a057))
* **engine:** expor constantes de espaco de cor de textura ([6025430](https://github.com/BuuhV-Projects/cortex-game-engine/commit/60254308ef256d59f22a23efa0fd1c618fcded42))
* **engine:** export em modo debug — HUD de FPS/CPU/memória/GPU na tela ([ad0bed5](https://github.com/BuuhV-Projects/cortex-game-engine/commit/ad0bed5599b9ba72d80b94ac07e70ebce290d76a))
* **export:** dev escolhe a pasta de saida (--out) + retry em outra pasta no lock ([9f14522](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9f14522b794e08e8b4c3c488cc42357bbd7b5044))
* **export:** ícone + identidade embutidos no launcher.exe ([9e3d82a](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9e3d82a1dc1c2bd515cd14a58efedd3277791fb4))
* **export:** identidade do jogo (id/name) no cortex.json + launcher.exe fixo ([5bcad7d](https://github.com/BuuhV-Projects/cortex-game-engine/commit/5bcad7d77a0bc9d5b27c1fe0a87433676e9bfaad))
* **export:** reporta processo+PID que trava dist-native (Restart Manager) ([f149edb](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f149edb3cea09c968430a64739936a3a9ff75b7d))
* **export:** Studio pergunta a pasta de saida por padrao (SPEC-0150) ([6f2e1fd](https://github.com/BuuhV-Projects/cortex-game-engine/commit/6f2e1fd984606094de18d7b53bd01e21744b8106))
* **i18n:** multi-idioma do jogo + config.ini (ADR-0124) ([1534b8b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/1534b8b0bcfb1b3047f719ca2327af5461f31864))
* **ia:** tool measure_glb (Node puro) + playtest determinístico (ADR-0116) ([965794d](https://github.com/BuuhV-Projects/cortex-game-engine/commit/965794dc8ac25dd0be01e4f4f8074a33be5eb56d))
* **ide:** instância única + higiene do disk cache ([c904047](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c904047ef2626c6167ed04950d194b8c0e04a6c6))
* **ide:** tool generate_blueprint no Chat IA (ADR-0142) ([2738fea](https://github.com/BuuhV-Projects/cortex-game-engine/commit/2738fea42b78c29e77773f1c79fb1829a0940fe2))
* **kit:** anotação semântica durável no kit (mechanic/note/altUse) ([3b13188](https://github.com/BuuhV-Projects/cortex-game-engine/commit/3b13188aec368a49bb8aff52271c0a435a3dc57b))
* **kit:** mecanicas de obstaculo no platformer-space ([55a899c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/55a899c2f59f8ad597973906d9029379b915da84))
* **kit:** pendulo de espetos e esteira animada no platformer-space ([b796045](https://github.com/BuuhV-Projects/cortex-game-engine/commit/b796045023e28274fd8487cd805e7c4c3996ade0))
* **kits:** adicionar o kit curado platformer-deathrun ([77f0325](https://github.com/BuuhV-Projects/cortex-game-engine/commit/77f0325620dde6befca279b84557a7e220316264))
* **kits:** kit platformer-space na engine (ADR-0053) ([4ceb7a5](https://github.com/BuuhV-Projects/cortex-game-engine/commit/4ceb7a56c951338081e3cb342fa959295ad1ba2b))
* **native:** __cortexPlatform injetado pré-boot (pc/xbox) ([78a2c93](https://github.com/BuuhV-Projects/cortex-game-engine/commit/78a2c9372205afae50c09fb1db9eed8e955e85b0))
* **native:** bloom em HDR — paridade de brilho com o Studio (ADR-0149) ([62769a6](https://github.com/BuuhV-Projects/cortex-game-engine/commit/62769a6d5582a87e8d5fb8f780be8fecc7fdeb51))
* **native:** diagnóstico completo no error_log.txt — log fatal do wgpu + stderr sem console ([c525f4c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c525f4cf0df57114d94c1cccc771931e15c62266))
* **native:** escrita de config.ini, locale do SO e languages/ no export (ADR-0124) ([8d34efe](https://github.com/BuuhV-Projects/cortex-game-engine/commit/8d34efe758757ac01f41073ee7b28e2c363558ed))
* **native:** M-perf-3 — IO assíncrono (thread pool) (SPEC-0137) ([2517c1c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/2517c1c13bdbf44e02524ca7fc705fa7c368a2fd))
* **native:** medidor de FPS opt-in no host (cortexPerf=1) ([114d7f4](https://github.com/BuuhV-Projects/cortex-game-engine/commit/114d7f4560a3c1d5895ee3db4b63284930a0cebf))
* **native:** runtime Hermes upstream estático no host — 2-3× no JS (ADR-0122) ([1f3f1a9](https://github.com/BuuhV-Projects/cortex-game-engine/commit/1f3f1a9c15b5f12971a4e9692a96a76bf2a1ac0b))
* **perf:** M-perf-0 — profiler de frame + contadores NAPI (SPEC-0134) ([70513c7](https://github.com/BuuhV-Projects/cortex-game-engine/commit/70513c710b1ff7a4de4ed548f147ec66f87b6ca5))
* **perf:** M-perf-1 — benchmark de cidade sintética + harness (ADR-0135) ([7850f0e](https://github.com/BuuhV-Projects/cortex-game-engine/commit/7850f0e09c616cc726d0d474735cfae13421fae0))
* **perf:** M-perf-2b — render bundles do estático (~2x fps) (SPEC-0136) ([79ca917](https://github.com/BuuhV-Projects/cortex-game-engine/commit/79ca917faa7f71e73621fdfa58db48136a2eda01))
* **scene:** água segue a câmera (mar infinito) (ADR-0132) ([f3778b6](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f3778b682ff3f7425bfc4929c86d427b3aab2107))
* **scene:** isentar objeto da nevoa com `fog` no no (SPEC-0145) ([e308cbb](https://github.com/BuuhV-Projects/cortex-game-engine/commit/e308cbb1a3bebc9614499cd3f0444ca3c117c73e))
* **scene:** M-perf-4 — streaming de células + LOD (mundo-aberto) (ADR-0138/0139) ([0126e56](https://github.com/BuuhV-Projects/cortex-game-engine/commit/0126e56bb6401c4ae6013df7b702879c5e8b6a25))
* **scene:** merge estático da cena no host nativo (ADR-0121) + plano de perf ajustado ([0812255](https://github.com/BuuhV-Projects/cortex-game-engine/commit/08122559c136fcf9562cb0d31e97187f1bee5648))
* **scene:** streaming — API de progresso de loading + splash cobre o pré-build ([69ed429](https://github.com/BuuhV-Projects/cortex-game-engine/commit/69ed4293863f9a2ac415c717bef7fefadb13bace))
* **skill-kit:** flag --theme no gen-kit e destino oficial dos kits ([0a6f56c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/0a6f56cf49485c0dc150194383893d8d2c8fc56c))
* **skill:** blueprint-fase orientado a gameplay ([44befda](https://github.com/BuuhV-Projects/cortex-game-engine/commit/44befda411823b394b397797fca98ec86c13867b))
* **skill:** pipeline montar-fase + agente level-builder ([a30e229](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a30e2291ddb05188b31ffd77b198894c18218e2b))
* **skill:** render 3D de level — maquete iso + 4 vistas de validação ([0ddc9f3](https://github.com/BuuhV-Projects/cortex-game-engine/commit/0ddc9f3691039215cb43dbe0067073dd3a906062))
* **skills:** skill blueprint-fase (kit → imagem de blueprint pra dev) ([1b37b9f](https://github.com/BuuhV-Projects/cortex-game-engine/commit/1b37b9f17ae59579ae753eae2f26a4bc79465015))
* **studio+native:** HUD de métricas no Studio e export com/sem métricas; error_log.txt e fix do present scale=1 ([f75fd84](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f75fd849c8eb1ff4746605499adcb726e09a2730))
* **studio:** UI "Configurações do jogo" (nome + ícone) no menu Projeto ([a1ee158](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a1ee1582e08b2f7eeee3e77748f00a8ce9aa4c77))
* **ui:** DOM-lite com nomes do HTML5 — alpha, gradientes, box-shadow duro e clip de imagem (ADR-0123) ([29ea58d](https://github.com/BuuhV-Projects/cortex-game-engine/commit/29ea58d12f442a6b35fe46db630145041173ff46))
* **ui:** escala responsiva da UI de runtime por resolução (ADR-0129) ([cab1ae3](https://github.com/BuuhV-Projects/cortex-game-engine/commit/cab1ae37f20fb790086c9060d1426a8a326a32dc))
* **ui:** loading pré-pintado e barra por etapa antes da carga (SPEC-0154) ([ab0f949](https://github.com/BuuhV-Projects/cortex-game-engine/commit/ab0f9493560272b221a071fa85a18cbb58594919))
* **ui:** mouse/toque nos menus — hit-test único no UiLayer (ADR-0133) ([a717fe6](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a717fe6efc6226b9f20de534f637f36a28b8de73))


### Performance Improvements

* **bench:** assa city.glb NÃO-interleaved (VertexLayout.SEPARATE) ([c6e572f](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c6e572f111917cd24ed273db64c83c6d28d8f621))
* **merge:** cache de de-interleave por fonte + opção de decimação no bench ([96e6975](https://github.com/BuuhV-Projects/cortex-game-engine/commit/96e6975a5b0ec12440ea55592e654122281b9f72))
* **merge:** merge de-interleava .glb reais → ~59 fps no bench (bate 60) ([cae1e1d](https://github.com/BuuhV-Projects/cortex-game-engine/commit/cae1e1db29d1ea3f7a3373ced8f26ae5e35c5552))
* **native:** build oficial do host com clang-cl — 60 fps cravado (70-73 na fase 1) ([0713e9c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/0713e9c9731871adccbc7aec481e035f8f2194c9))
* **native:** KTX2→BC7 + teto de heap + skybox/PMREM residentes (SPEC-0155) ([553eca5](https://github.com/BuuhV-Projects/cortex-game-engine/commit/553eca50946a537ded8ffddf60739e6e00af5300))
* **native:** mover bloom e vinheta pro host em C++ (ADR-0147/SPEC-0148) ([38e5d8b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/38e5d8b94a4abb697e123d9d3ca20262fe7044f0))
...
* **editor:** trocar de shader não pode apagar o material autorado na cena (SPEC-0110) ([dc24f9c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/dc24f9c62c1e37fe714e3d0de2f99562085f2159)), closes [#ffd83](https://github.com/BuuhV-Projects/cortex-game-engine/issues/ffd83)
...
* **kits:** adicionar kit characters-cute (personagem modular, SPEC-0068) ([87afdd4](https://github.com/BuuhV-Projects/cortex-game-engine/commit/87afdd4542778993fd4d26a8fdc430c4b43dfccd))
...
* **native:** M1 frente 2 — input SDL->JS + Gamepad API; SPEC-0095 (export PC = CortexNative) ([daa507b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/daa507b2c750a475e29061cb4620ee7247c1f644))
...
* **native:** save persistente no host — localStorage sobre user_storage (SPEC-0106) ([071139e](https://github.com/BuuhV-Projects/cortex-game-engine/commit/071139e72eb411152eb718fe0f6622ec85319999))
...
* **physics:** BVH acelera o raycast de colisão do Character (SPEC-0108) ([c53d404](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c53d404d0242b104f607e240a5b3826be8bd9bb0))
...
* **editor:** arrastar asset pra cena — FileTree/painel Add → viewport (SPEC-0090) ([71fc8f4](https://github.com/BuuhV-Projects/cortex-game-engine/commit/71fc8f474e9a6acb732769e35fe66176d57cfaf6))
...
* **editor:** CTRL+C/CTRL+V duplica modelos .glb (SPEC-0095) ([3f9bede](https://github.com/BuuhV-Projects/cortex-game-engine/commit/3f9bede2c6f3fc0b0b9da98ba7af184fa210f780))
* **editor:** CTRL+Z — fase 1a: CommandStack + undo de transform (gizmo) (SPEC-0084) ([022e491](https://github.com/BuuhV-Projects/cortex-game-engine/commit/022e491f5550814cb248a7313ad258a011aced6e))
* **editor:** CTRL+Z fase 1b — undo de adicionar/deletar nó (SPEC-0084) ([348e68a](https://github.com/BuuhV-Projects/cortex-game-engine/commit/348e68a50d035ee19e0ef3a3f4f739a4407ccadd))
...
* **editor:** level design com .glb — picker com busca, thumbs 3D e desenhar moldado (SPEC-0093) ([9d0022b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/9d0022b23dc954dc3c8c5091e7efd296f39fbdc4))
...
* **editor:** overlay de cena POR FASE — Game.sceneDataUrl (SPEC-0094) ([045e52b](https://github.com/BuuhV-Projects/cortex-game-engine/commit/045e52bb0a57de8f6562141405bd70a7b6a53bea))
...
* **editor:** pincel de espalhar vegetação (SPEC-0077, fase 2) ([5eedd6c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/5eedd6ce47feb72e11732ae09b40f66292cacc67))
...
* **editor:** renomear objeto no Inspector — só nós adicionados (SPEC-0091) ([5108a2c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/5108a2c52c8032eb2a37e18379ff9202eeec1bb0))
...
* **interaction:** sistema de action genérico (engine) — SPEC-0080 ([29ee78c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/29ee78cfde371af872e1855217fb65c6d14bf176))
* **lighting:** Cascaded Shadow Maps (CSM/WebGPU) pra mundo aberto (SPEC-0082) ([c4a57d1](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c4a57d10ee5f524523cd67b02f755cd1610e0647))
...
* **probuilder:** blockout estilo ProBuilder com nó mesh editável (SPEC-0071) ([cc7d9a0](https://github.com/BuuhV-Projects/cortex-game-engine/commit/cc7d9a07fb46ad0146121fea7655e23f50d0b22c))
...
* **road:** sistema de estradas por spline — Fase 1 (SPEC-0072) ([c2eed37](https://github.com/BuuhV-Projects/cortex-game-engine/commit/c2eed378d2becd738c9e094c61570c8ba878e4b2))
...
* **scene:** underlay — imagem de referência no chão pra blockout (SPEC-0083) ([f29f422](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f29f42246eb7f4228816241d7ea4b3ae088a6d62))
* **scripts:** auto-registro da pasta scripts/ — nome pelo arquivo (SPEC-0096) ([29d3df6](https://github.com/BuuhV-Projects/cortex-game-engine/commit/29d3df60a177caa8e645a0ae053c605145d3ddac))
...
* **vegetation:** núcleo instanciado + nó vegetation (SPEC-0077, fase 1) ([a62b7b6](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a62b7b6ee377cb85453b8914c521af91bc86f124))
...
* **editor:** ferramenta de esculpir terreno — pincel raise/lower (SPEC-0059 T2) ([bfd4c09](https://github.com/BuuhV-Projects/cortex-game-engine/commit/bfd4c098998d2dda9ea304d445aed2b46886b370))
...
* **engine:** terreno heightmap esculpível — Terrain + nó data-driven (SPEC-0059 T1) ([f6f6057](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f6f6057b612abeb31f22658cc94745b4662eafaa))
* **engine:** terreno sólido por padrão — colisão por heightmap (SPEC-0059 T3) ([f6a152c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/f6a152ccfcfdd0d163057ca3a76c1921376f04e4))
...
* **editor:** seção Shader no inspector — escolhe material por objeto (SPEC-0058 S3) ([5c4b7a8](https://github.com/BuuhV-Projects/cortex-game-engine/commit/5c4b7a8fc3892abe562059f27c4071023f5e5817))
...
* **engine:** nó sprite 2D data-driven na cena (SPEC-0057) ([a9114ab](https://github.com/BuuhV-Projects/cortex-game-engine/commit/a9114abc59ef865eee7b55642de362b4d3ced032))
* **engine:** sistema de material/shader por objeto — preset unlit (SPEC-0058) ([430acc0](https://github.com/BuuhV-Projects/cortex-game-engine/commit/430acc0b7cbe353760d91414a30e331b6558d7ef))
...
* **physics:** colisão capsule via composição cylinder + 2 esferas (SPEC-0027 Fase 5) ([4b20193](https://github.com/BuuhV-Projects/cortex-game-engine/commit/4b20193465ca79a8bf7f05e7af1c7d61dcdd525a))
* **physics:** colisão cylinder + box↔cylinder + sphere↔cylinder (SPEC-0027 Fase 4) ([d90d118](https://github.com/BuuhV-Projects/cortex-game-engine/commit/d90d118f38dc86cc16be467ee8dfabc6255f6740))
* **physics:** colisão sphere e box↔sphere (SPEC-0027 Fase 3) ([076a782](https://github.com/BuuhV-Projects/cortex-game-engine/commit/076a78267729cc2996206027abe1c7a6fa677fd7))
* **physics:** ColliderComponent ganha shape discriminado (SPEC-0027 Fase 1) ([8b7725c](https://github.com/BuuhV-Projects/cortex-game-engine/commit/8b7725c94f9171c25520de0531cde63fcffc4629))
