# SPEC-0038 - Editor embutido ligado no template starter + IA o reusa
...
O engine tem um modo editor embutido (SPEC-0030): `EditorState`,
...
- `onSaveEdits` no template só notifica (toast + console); persistir de fato é
  responsabilidade do jogo (ligar ao `SceneFileWriter`/IO, SPEC-0031).
