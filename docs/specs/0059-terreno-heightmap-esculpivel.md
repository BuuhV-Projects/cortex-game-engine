# SPEC-0059 - Terreno heightmap esculpível (estilo Unity)

**Data:** 2026-06-10
**Status:** aceito (T1 engine mesh/heightmap/sculpt + T2 ferramenta de esculpir no editor + T3 colisão sólida; T4 pintura de textura/splat: ver SPEC-0063)
