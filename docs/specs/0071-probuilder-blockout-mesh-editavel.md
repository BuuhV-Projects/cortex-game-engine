# SPEC-0071 - ProBuilder: blockout com malha editável (nó `mesh`)
...
**conteúdo autoral** — geometria é DADO da cena, como o heightmap do terreno (SPEC-0059)
...
do nó, autoritativa no overlay, dona do transform conforme o SPEC-0058. Zero conflito.
