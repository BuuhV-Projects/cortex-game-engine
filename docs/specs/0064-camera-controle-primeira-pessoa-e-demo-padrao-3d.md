# SPEC-0064 - Câmera/controle de 1ª pessoa (FPS) e demo padrão 3D
...
cena, inclui terreno) e o nó `terrain` (esculpível/pintável, SPEC-0059/0063) — mas
...
3. **Demo padrão = terreno vazio + player cápsula em 1ª pessoa.** O
   ...
   editável no Inspector (regra do CLAUDE.md / SPEC-0058): o que é "wiring de
