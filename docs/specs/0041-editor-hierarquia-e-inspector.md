# SPEC-0041 - Editor: hierarquia (outliner) + inspector com seleção observável
...
O modo editor embutido (SPEC-0030/0038) tinha câmera de voo livre + gizmo
...
- Relaciona-se com SPEC-0030/0038 (editor) e usa `setShadows` do SPEC-0040.
