# SPEC-0079 - Seleção por instância de vegetação no editor
...
A vegetação é `InstancedMesh` (SPEC-0077): centenas de árvores num grupo, com 2
...
- A colisão da árvore continua sendo **propriedade do objeto** (`cortexSolid`/`collide`),
  independente da seleção. Ver [[SPEC-0077]].
