# SPEC-0076 - Marcação de pista (overlay)

**Data:** 2026-06-27
**Status:** aceito — parte da **Fase 2** do [SPEC-0072](0072-sistema-de-estradas-spline-road-architect.md)

## Contexto

As estradas (SPEC-0072/0075) já têm forma, textura e relação com o terreno, mas **sem
