# SPEC-0050 - Boot em modo edição + Play/Stop (estilo Unity)
...
O editor embutido (F2, SPEC-0030/0042/0047) era um **overlay sobre o jogo rodando**:
...
1. **Boot em modo EDIÇÃO por padrão** (dev): `attachEditor` inicia
   ...
   (SPEC-0046), então o jogo abre editável e parado.
...
- Relaciona-se com SPEC-0030/0042 (editor, bundle dev), 0046 (pausa no editor) e
