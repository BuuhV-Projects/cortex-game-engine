# SPEC-0063 - Pintura de textura do terreno (splat) com pincel no editor
...
O terreno esculpível (SPEC-0059) tinha cor única (`MeshStandardMaterial` verde) e o
...
- Trocar o **Shader** (SPEC-0058) do objeto-terreno substitui o material e perde o
...
Substitui o item "pendente: pintura de textura/splat" do SPEC-0059.
