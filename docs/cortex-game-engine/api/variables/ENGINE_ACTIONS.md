...
Defined in: [.claude/worktrees/boot-cooperativo/src/input/defaultActions.ts:53](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/input/defaultActions.ts#L53)
