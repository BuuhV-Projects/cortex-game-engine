...
Defined in: [.claude/worktrees/perf-boot-nativo/src/core/steamworks.ts:92](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/core/steamworks.ts#L92)
