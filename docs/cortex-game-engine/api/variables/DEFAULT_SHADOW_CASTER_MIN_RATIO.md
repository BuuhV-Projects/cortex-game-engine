...
Defined in: [.claude/worktrees/perf-boot-nativo/src/scene/ShadowCasterCulling.ts:27](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/ShadowCasterCulling.ts#L27)
