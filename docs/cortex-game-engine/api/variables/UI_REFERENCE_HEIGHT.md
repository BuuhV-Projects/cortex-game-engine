...
Defined in: [.claude/worktrees/perf-boot-nativo/src/ui/runtime/layout.ts:51](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/ui/runtime/layout.ts#L51)
