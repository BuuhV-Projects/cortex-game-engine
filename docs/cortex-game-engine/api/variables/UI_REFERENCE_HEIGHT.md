...
Defined in: [.claude/worktrees/boot-cooperativo/src/ui/runtime/layout.ts:51](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/ui/runtime/layout.ts#L51)
