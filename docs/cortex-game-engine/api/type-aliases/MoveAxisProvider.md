...
Defined in: [.claude/worktrees/perf-boot-nativo/src/systems/TopDownMovementSystem.ts:12](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/systems/TopDownMovementSystem.ts#L12)
