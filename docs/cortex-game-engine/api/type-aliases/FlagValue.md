...
Defined in: [.claude/worktrees/perf-boot-nativo/src/narrative/StoryState.ts:16](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/narrative/StoryState.ts#L16)
