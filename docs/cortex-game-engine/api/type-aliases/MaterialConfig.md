...
Defined in: [.claude/worktrees/feat-input-rebind/src/scene/Materials.ts:43](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/Materials.ts#L43)
