...
Defined in: [.claude/worktrees/perf-boot-nativo/src/core/Physics.ts:63](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/core/Physics.ts#L63)
