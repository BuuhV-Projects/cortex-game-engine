...
Defined in: [.claude/worktrees/perf-boot-nativo/src/components/RapierBodyComponent.ts:8](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/components/RapierBodyComponent.ts#L8)
