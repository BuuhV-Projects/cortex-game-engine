...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:36](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L36)
...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:37](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L37)
...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:40](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L40)
...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:44](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L44)
...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:42](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L42)
...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:38](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L38)

***

### severity?

> `optional` **severity?**: `Record`\<`string`, `"off"` \| `"error"` \| `"warning"`\>

Defined in: [.claude/worktrees/boot-cooperativo/src/scene/validateScene.ts:50](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/validateScene.ts#L50)
