...
Defined in: [.claude/worktrees/boot-cooperativo/src/ui/runtime/layout.ts:64](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/ui/runtime/layout.ts#L64)
