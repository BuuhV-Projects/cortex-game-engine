...
Defined in: [.claude/worktrees/boot-cooperativo/src/input/ControlsScreen.ts:128](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/input/ControlsScreen.ts#L128)
