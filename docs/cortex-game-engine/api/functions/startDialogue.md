...
Defined in: [.claude/worktrees/perf-boot-nativo/src/dialogue/startDialogue.ts:47](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/dialogue/startDialogue.ts#L47)
