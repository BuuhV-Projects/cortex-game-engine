...
Defined in: [.claude/worktrees/feat-input-rebind/src/scene/SceneBuilder.ts:428](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/SceneBuilder.ts#L428)
