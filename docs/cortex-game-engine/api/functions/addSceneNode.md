...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/SceneBuilder.ts:986](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/SceneBuilder.ts#L986)
...
\{ `socket`: `string`; `to`: `string`; `toSocket`: `string`; \} = `attachSchema`

Encaixe por socket no lugar de coordenadas (ver attachSchema; ADR-0053).
...
\{ `height?`: `number`; `offsetX?`: `number`; `offsetY?`: `number`; `oneWay?`: `boolean`; `points?`: \[`number`, `number`\][]; `shape?`: `"box"` \| `"circle"` \| `"capsule"` \| `"heightfield"`; `solid?`: `boolean`; `width?`: `number`; \} = `colliderSchema`
...
\{ `type`: `"standard"`; \} \| \{ `alphaTest?`: `number`; `color?`: `string` \| `number`; `cull?`: `"back"` \| `"front"` \| `"none"`; `depthTest?`: `boolean`; `depthWrite?`: `boolean`; `opacity?`: `number`; `outline?`: `number`; `outlineColor?`: `string` \| `number`; `textured?`: `boolean`; `transparent?`: `boolean`; `type`: `"unlit"`; \} \| \{ `color?`: `string` \| `number`; `gradientSteps?`: `number`; `outline?`: `number`; `outlineColor?`: `string` \| `number`; `preserveGloss?`: `boolean`; `shading?`: `"bands"` \| `"cel"`; `type`: `"toon"`; \} = `materialSchema`
...
\{ `kind`: `"cylinder"` \| `"plane"` \| `"sphere"` \| `"cube"` \| `"cone"` \| `"stairs"` \| `"ramp"` \| `"arch"` \| `"wallOpening"`; `params?`: `Record`\<`string`, `number`\>; \} = `...`

##### shape.kind

`"cylinder"` \| `"plane"` \| `"sphere"` \| `"cube"` \| `"cone"` \| `"stairs"` \| `"ramp"` \| `"arch"` \| `"wallOpening"` = `...`
...
\{ `blending?`: `"additive"` \| `"normal"`; `burst?`: `number`; `color?`: `string` \| `number`; `direction?`: \[`number`, `number`, `number`\]; `drag?`: `number`; `gravity?`: `number`; `id`: `string`; `life?`: `number` \| \[`number`, `number`\]; `loop?`: `boolean`; `max?`: `number`; `opacity?`: `number`; `place?`: \{ `rotY?`: `number`; `scale?`: `number`; `x?`: `number`; `y?`: `number`; `z?`: `number`; \}; `rate?`: `number`; `size?`: `number` \| \[`number`, `number`\]; `speed?`: `number` \| \[`number`, `number`\]; `spin?`: `number` \| \[`number`, `number`\]; `spread?`: `number`; `texture?`: `string`; `type`: `"particles"`; \}
...
\{ `rotY?`: `number`; `scale?`: `number`; `x?`: `number`; `y?`: `number`; `z?`: `number`; \} = `...`
...
\{ `causticsIntensity?`: `number`; `causticsUrl?`: `string`; `color?`: `string` \| `number`; `flowSpeed?`: \[`number`, `number`\]; `follow?`: `boolean`; `id`: `string`; `repeat?`: `number`; `size?`: `number`; `type`: `"water"`; `y?`: `number`; \}
