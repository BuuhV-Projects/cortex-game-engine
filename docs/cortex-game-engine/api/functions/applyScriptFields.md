...
Defined in: [.claude/worktrees/boot-cooperativo/src/systems/ScriptHostSystem.ts:12](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/systems/ScriptHostSystem.ts#L12)
