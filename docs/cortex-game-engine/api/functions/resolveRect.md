...
Defined in: [.claude/worktrees/perf-boot-nativo/src/ui/runtime/layout.ts:90](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/ui/runtime/layout.ts#L90)
