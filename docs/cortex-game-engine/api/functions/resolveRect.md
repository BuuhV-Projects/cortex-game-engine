...
Defined in: [.claude/worktrees/boot-cooperativo/src/ui/runtime/layout.ts:90](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/ui/runtime/layout.ts#L90)
