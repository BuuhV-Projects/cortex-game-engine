...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/Sprite.ts:56](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/Sprite.ts#L56)
