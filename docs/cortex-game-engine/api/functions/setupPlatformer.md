...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/Platformer.ts:32](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/Platformer.ts#L32)
