...
Defined in: [.claude/worktrees/perf-boot-nativo/src/scene/Platformer.ts:32](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/Platformer.ts#L32)
