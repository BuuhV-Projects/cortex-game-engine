...
Defined in: [src/scene/SceneDefinition.ts:617](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/SceneDefinition.ts#L617)
...
> `optional` **profile?**: `"dirt"` \| `"highway"` \| `"arterial"` \| `"urban_primary"` \| `"urban_secondary"` \| `"residential"` \| `"industrial"` \| `"pedestrian_market"` \| `"alley"`
