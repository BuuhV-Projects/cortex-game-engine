...
Defined in: [.claude/worktrees/feat-input-rebind/src/scene/StaticMerge.ts:372](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/StaticMerge.ts#L372)
