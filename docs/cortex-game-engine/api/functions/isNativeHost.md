...
Defined in: [.claude/worktrees/perf-boot-nativo/src/scene/StaticMerge.ts:369](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/StaticMerge.ts#L369)
