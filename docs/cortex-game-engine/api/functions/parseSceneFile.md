...
Defined in: [.claude/worktrees/feat-input-rebind/src/scene/SceneFile.ts:46](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/SceneFile.ts#L46)
