...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/SceneFile.ts:46](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/SceneFile.ts#L46)
