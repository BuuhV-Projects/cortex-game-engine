...
Defined in: [.claude/worktrees/boot-cooperativo/src/scripts/ScriptRegistry.ts:38](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scripts/ScriptRegistry.ts#L38)
