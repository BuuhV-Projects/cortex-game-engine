...
Defined in: [.claude/worktrees/boot-cooperativo/src/dialogue/DialogueUI.ts:42](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/dialogue/DialogueUI.ts#L42)
