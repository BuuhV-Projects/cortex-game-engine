...
Defined in: [.claude/worktrees/perf-boot-nativo/src/dialogue/DialogueUI.ts:42](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/dialogue/DialogueUI.ts#L42)
