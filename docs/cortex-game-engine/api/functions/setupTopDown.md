...
Defined in: [.claude/worktrees/perf-boot-nativo/src/scene/TopDown.ts:51](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/TopDown.ts#L51)
