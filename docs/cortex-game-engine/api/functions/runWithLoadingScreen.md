...
Defined in: [.claude/worktrees/perf-boot-nativo/src/core/LoadingScreen.ts:143](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/core/LoadingScreen.ts#L143)
