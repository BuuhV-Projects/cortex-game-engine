...
Defined in: [.claude/worktrees/boot-cooperativo/src/core/AssetLoader.ts:45](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/core/AssetLoader.ts#L45)
