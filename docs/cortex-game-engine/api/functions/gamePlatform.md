...
Defined in: [.claude/worktrees/boot-cooperativo/src/core/gamePlatform.ts:34](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/core/gamePlatform.ts#L34)
