...
Defined in: [.claude/worktrees/feat-input-rebind/src/scene/StaticMerge.ts:347](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/StaticMerge.ts#L347)
