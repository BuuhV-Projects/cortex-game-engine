...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/StaticMerge.ts:344](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/StaticMerge.ts#L344)
