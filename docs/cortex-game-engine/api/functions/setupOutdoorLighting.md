...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/OutdoorLighting.ts:150](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/OutdoorLighting.ts#L150)
