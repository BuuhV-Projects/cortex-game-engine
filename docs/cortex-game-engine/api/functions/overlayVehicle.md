...
Defined in: [.claude/worktrees/perf-boot-nativo/src/scene/SceneBuilder.ts:321](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/SceneBuilder.ts#L321)
