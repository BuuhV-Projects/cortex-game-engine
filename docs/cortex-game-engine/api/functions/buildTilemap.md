...
Defined in: [.claude/worktrees/boot-cooperativo/src/scene/Tilemap.ts:62](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/scene/Tilemap.ts#L62)
