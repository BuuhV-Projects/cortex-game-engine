...
Defined in: [.claude/worktrees/perf-boot-nativo/src/ui/runtime/UiTemplate.ts:260](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/ui/runtime/UiTemplate.ts#L260)
