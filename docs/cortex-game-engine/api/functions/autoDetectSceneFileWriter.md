...
Defined in: [.claude/worktrees/perf-boot-nativo/src/io/autoDetectSceneFileWriter.ts:14](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/io/autoDetectSceneFileWriter.ts#L14)
