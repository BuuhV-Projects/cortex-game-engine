...
- [HostChannel](classes/HostChannel.md)
...
- [HOST\_CHANNEL\_PROTOCOL](variables/HOST_CHANNEL_PROTOCOL.md)
...
- [getHostChannel](functions/getHostChannel.md)
...
- [resetHostChannel](functions/resetHostChannel.md)
