...
Defined in: [.claude/worktrees/boot-cooperativo/src/components/FollowCameraTargetComponent.ts:7](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/components/FollowCameraTargetComponent.ts#L7)
