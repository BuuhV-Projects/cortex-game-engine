...
Defined in: [.claude/worktrees/perf-boot-nativo/src/components/FollowCameraTargetComponent.ts:7](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/components/FollowCameraTargetComponent.ts#L7)
