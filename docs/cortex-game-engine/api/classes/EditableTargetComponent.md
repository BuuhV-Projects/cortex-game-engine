...
Defined in: [.claude/worktrees/boot-cooperativo/src/components/EditableTargetComponent.ts:8](https://github.com/BuuhV-Projects/cortex-game-engine/blob/main/src/components/EditableTargetComponent.ts#L8)
