# 0093 - Picker "Adicionar modelo (.glb)" no blockout (modal com busca)
...
O blockout (ADR-0071) só oferecia primitivas paramétricas; colocar uma peça REAL
de kit exigia arrastar da árvore de arquivos (ADR-0090) — bom pra 1 peça, lento
