# 0133 - Mouse/toque na UI de runtime (hit-test único no UiLayer)
...
- O layout dos dois backends é o **mesmo** (espaço de design = viewport real ÷
  escala, ADR-0129) e o `resolveRect` é compartilhado — logo o hit-test pode ser
...
- **Coordenada → design:** `design = client ÷ escala` (a mesma escala do ADR-0129).
