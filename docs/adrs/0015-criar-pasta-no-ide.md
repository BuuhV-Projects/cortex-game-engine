# 0015 - Criar pasta no IDE

**Data:** 2026-05-25
**Status:** aceito (extensão do ADR-0011)

## Contexto

A ADR-0011 cobriu "criar arquivo" mas deixou criar pasta para iteração
...
Mesmo padrão da ADR-0011, mas para diretórios:
...
- Reusa toda a infra da ADR-0011 (validação, prompt, refresh).
