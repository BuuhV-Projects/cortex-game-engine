# 0111 - Kit de personagem modular: roles `character-part` e `rig` no vocabulário
...
ADR-0068), mas nenhum kit fornecia o material no formato esperado (um `rig.glb` +
...
- Criador de personagem/NPCs com mistura livre vira possível com material real;
  o custo de disco é nº de peças, não de combinações (ADR-0068).
