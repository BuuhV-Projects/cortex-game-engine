...
describe('UiStylesheet — CSS que compila pro subset nativo (ADR-0102)', () => {
  it('gradiente + radius + tamanho num Panel', () => {
    ...
    expect(panel.background).toBe('#7ed6f7');
    expect(panel.backgroundTo).toBe('#1e8fc4');
  ...
  it('propriedade fora do subset = erro claro na COMPILAÇÃO', () => {
