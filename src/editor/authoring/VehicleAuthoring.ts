  ...
  return {
    get(obj: Object3D): VehicleEditState | null {
      ...
      return {
        ...
        maxSuspensionTravel: n(merged['maxSuspensionTravel'], DEFAULTS.maxSuspensionTravel),
        suspensionCompression: n(merged['suspensionCompression'], DEFAULTS.suspensionCompression),
